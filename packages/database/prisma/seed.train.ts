  ...
  // ── 5. CALMING ───────────────────────────────────────────────────────────────
  {
    ...
    patterns: [
      ...
      },
      {
        ...
        // Classic anti-panic / anxiety-relief pattern attributed to breath work tradition
        code: "478-calm",
        ru: {
          title: "4-7-8 Дыхание",
          subtitle: "Panic relief",
          description: "Вдох 4с, задержка 7с, выдох 8с. Снимает тревогу и помогает быстро успокоиться.",
        },
        en: {
          title: "4-7-8 Breathing",
          subtitle: "Panic relief",
          description: "Inhale 4s, hold 7s, exhale 8s. Reduces anxiety and helps you calm quickly.",
        },
        build: (points) =>
          buildSteps([
            { phase: BreathPhase.INHALE, durationSeconds: 4 },
            { phase: BreathPhase.HOLD, durationSeconds: 7 },
            { phase: BreathPhase.EXHALE, durationSeconds: 8 },
          ], points),
        repeats: () => 3,
        intensity: () => 1,
